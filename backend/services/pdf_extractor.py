    ...
    for page_num in range(len(doc)):
        ...
        for img_idx, img in enumerate(image_list):
            ...
            try:
                ...
                # Auto-generate detailed caption using vision model
                from services.image_captioner import image_captioner
                auto_caption = image_captioner.caption_image(image_filepath)
                caption = auto_caption if auto_caption else f"Figure {img_idx + 1} on page {page_num + 1}"
